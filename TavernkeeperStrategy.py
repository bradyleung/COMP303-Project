...
class TavernkeeperStrategy(NPCStrategy):
    ...
    def __init__(self, tavern: TavernEnvironment, wrapper: APIWrapper):
        ...
        # Tavernkeeper has a dictionary to store the descriptions of each customer to be able to describe them
        self._descriptions = {
    ...
    def interact(self, npc_name: str) -> str:
        ...
        prompt = self._descriptions.get(npc_name) + "You are a playful tavernkeeper in a midieval tavern, introduce this customer in 50 words or less by paraphrasing their description. "
